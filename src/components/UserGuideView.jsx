    ...
    vn: {
        ...
        tabs: [
            ...
            },
            {
                ...
                name: 'DocStudio',
                color: 'indigo',
                what: 'Soạn tài liệu cấu trúc từ Markdown hoặc file văn bản thô. Hỗ trợ xem trước A4, kiểm tra lỗi, xuất DOCX/PDF.',
                steps: [
                    '1. Chuyển sang tab DocStudio ở thanh tab',
                    '2. Bấm 「Tạo tài liệu」 để mở trình soạn thảo',
                    '3. Nhập nội dung Markdown vào ô bên trái (hoặc bấm 「Tải file lên」 để upload file .txt/.md)',
                    '4. Bấm 「Tạo bản xem trước」 để xem tài liệu định dạng A4 bên phải',
                    '5. Kiểm tra cảnh báo/lỗi ở bảng Validation bên dưới',
                    '6. Bấm PDF hoặc DOCX để xuất file',
                ],
                tips: [
                    'Hỗ trợ Markdown: # Tiêu đề, - Danh sách, | Bảng |, > Trích dẫn, ::signature::',
                    'Upload file .txt hoặc .md → ứng dụng tự định dạng lại theo mẫu A4',
                    'Giao diện đa ngôn ngữ: tự chuyển ngôn ngữ theo tab chính (VN/EN/JP)',
                    'Xử lý hoàn toàn trên trình duyệt, không upload lên server',
                ],
            },
        ],
    ...
    en: {
        ...
        tabs: [
            ...
            },
            {
                ...
                name: 'DocStudio',
                color: 'indigo',
                what: 'Create structured documents from Markdown or raw text files. Supports A4 preview, validation, and DOCX/PDF export.',
                steps: [
                    '1. Switch to the DocStudio tab in the tab bar',
                    '2. Click 「Create Document」 to open the editor',
                    '3. Type Markdown content in the left panel (or click 「Upload File」 to load a .txt/.md file)',
                    '4. Click 「Generate Preview」 to see the formatted A4 document on the right',
                    '5. Review warnings/errors in the Validation panel below',
                    '6. Click PDF or DOCX to export the document',
                ],
                tips: [
                    'Markdown support: # Headings, - Lists, | Tables |, > Quotes, ::signature::',
                    'Upload .txt or .md files → app auto-formats into A4 layout',
                    'Multilingual UI: automatically syncs language with main tabs (VN/EN/JP)',
                    'Processed entirely in browser, no server upload',
                ],
            },
        ],
    ...
    jp: {
        ...
        tabs: [
            ...
            },
            {
                ...
                name: 'DocStudio',
                color: 'indigo',
                what: 'Markdownまたはテキストファイルから構造化ドキュメントを作成。A4プレビュー・バリデーション・DOCX/PDFエクスポート対応。',
                steps: [
                    '1. タブバーでDocStudioタブに切り替え',
                    '2.「ドキュメント作成」をクリックしてエディタを開く',
                    '3. 左パネルにMarkdownを入力（または「ファイルをアップロード」で.txt/.mdファイルを読み込み）',
                    '4.「プレビュー生成」をクリックして右側にA4書式化ドキュメントを表示',
                    '5. 下の検証パネルで警告/エラーを確認',
                    '6. PDFまたはDOCXでドキュメントをエクスポート',
                ],
                tips: [
                    'Markdown対応：# 見出し、- リスト、| テーブル |、> 引用、::signature::',
                    '.txtまたは.mdファイルアップロード→自動A4レイアウト整形',
                    '多言語UI：メインタブに連動して言語を自動切替（VN/EN/JP）',
                    'ブラウザ内で完結、サーバーへのアップロードなし',
                ],
            },
        ],
    },
